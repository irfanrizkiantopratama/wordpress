...
class Hoot_Taxonomy_Field {
	...
	public function taxonomy_columns_header( $defaults ){
		$defaults['hoot_term_img']  = __( 'Featured Image', 'hoot-du' );
		return $defaults;
	}
	...
	public function taxonomy_column( $columns, $column, $id ){
		if ( 'hoot_term_img' === $column ) {
			...
			$columns .= '<img data-id="'.$thumbnail_id.'" src="' . esc_url( $image ) . '" alt="' . esc_attr__( 'Thumbnail', 'hoot-du' ) . '" class="hoot_term_img" width="35px" />';
		}
		return $columns;
	}
	...
	public function add_taxonomy_field( $term ) {
		...
		?><div class="form-field">
			<label for="hoot_term_img"><?php esc_html_e( 'Featured Image', 'hoot-du' ); ?></label>
			...
			<button type="button" class="hoot_term_img_add button"><?php esc_html_e( 'Upload/Add image', 'hoot-du' ); ?></button>
			<button type="button" class="hoot_term_img_remove button"><?php esc_html_e( 'Remove image', 'hoot-du' ); ?></button>
		</div><?php
	}
