...
$searchlabel = apply_filters( 'hootdu_search_label', __( 'Search', 'hoot-du' ) );
$searchplaceholder = apply_filters( 'hootdu_search_placeholder', __( 'Type Search Term &hellip;', 'hoot-du' ) );
$searchsubmit = apply_filters( 'hootdu_search_submit', __( 'Search', 'hoot-du' ) );
