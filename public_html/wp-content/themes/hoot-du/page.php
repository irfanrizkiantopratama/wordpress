...
hootdu_add_custom_title_content( 'pre', 'page.php' );
if ( hootdu_titlearea_top() ) {
	hootdu_loopmeta_header_img( 'page', false );
	get_template_part( 'template-parts/loop-meta' ); // Loads the template-parts/loop-meta.php template to display Title Area with Meta Info (of the loop)
	hootdu_add_custom_title_content( 'post', 'page.php' );
} else {
	hootdu_loopmeta_header_img( 'page', true );
}

// Template modification Hook
do_action( 'hootdu_before_content_grid', 'page.php' );
?>
...
<div class="hgrid main-content-grid">
	...
	<main <?php hoot_attr( 'content' ); ?>>
		<div <?php hoot_attr( 'content-wrap', 'page' ); ?>>
			...
			<?php
			// Template modification Hook
			do_action( 'hootdu_main_start', 'page.php' );
			...
			if ( have_posts() ) :
				...
				if ( hoot_get_mod( 'post_featured_image_page' ) == 'content' ) {
					$img_size = apply_filters( 'hootdu_page_imgsize', '', 'content' );
				...
				// Template modification Hook
				do_action( 'hootdu_loop_start', 'page.php' );
				...
				// Template modification Hook
				do_action( 'hootdu_loop_end', 'page.php' );

				// Template modification Hook
				do_action( 'hootdu_after_content_wrap', 'page.php' );
			...
			// Template modification Hook
			do_action( 'hootdu_main_end', 'page.php' );
			?>
