 ...
 * @return void
 */
function hootdu_add_appearance_subpage() {

	add_theme_page(
		__( 'Hoot Du', 'hoot-du' ), // Page Title
		__( 'About Theme Options', 'hoot-du' ), // Menu Title
		'edit_theme_options', // capability
		'hoot-du-welcome', // menu-slug
		'hootdu_appearance_subpage' // function name
		);

	add_action( 'admin_enqueue_scripts', 'hootdu_admin_enqueue_about_styles' );

}
/* Add the admin setup function to the 'admin_menu' hook. */
add_action( 'admin_menu', 'hootdu_add_appearance_subpage' );
 ...
 * @return void
 */
function hootdu_welcome_notice(){
	if ( isset( $_GET['page'] ) && $_GET['page'] == 'hoot-du-welcome' )
		return;
	if ( ! get_option( 'hoot-du-dismiss-welcome' ) ) {
		add_action( 'admin_notices', 'hootdu_add_welcome_notice' );
	}
}
add_action( 'admin_head', 'hootdu_welcome_notice' );
 ...
 * @return void
 */
function hootdu_add_welcome_notice() {
	?>
	<div id="hoot-welcome-msg" class="notice notice-success is-dismissible">
		<p><?php
			...
			printf( esc_html__( 'Thank you for choosing Hoot Du! To get started and fully take advantage of our theme, please make sure you visit the welcome page for the %1$sQuick Start Guide%2$s.', 'hoot-du' ), '<a href="' . esc_url( admin_url( 'themes.php?page=hoot-du-welcome&tab=qstart' ) ) . '">', '</a>' );
			?></p>
		<p><?php
			/* Translators: 1 is the link start markup, 2 is link markup end */
			printf( esc_html__( '%1$sGet started with Hoot Du%2$s', 'hoot-du' ), '<a class="button-secondary" href="' . esc_url( admin_url( 'themes.php?page=hoot-du-welcome&tab=qstart' ) ) . '">', '</a>' );
			?></p>
	</div>
	<?php
}
 ...
 * @return void
 */
function hootdu_dismiss_welcome_notice() {
	check_ajax_referer( 'dismiss-hoottheme-welcome', 'nonce' );
	update_option( 'hoot-du-dismiss-welcome', 1 );
	wp_die();
}
add_action( 'wp_ajax_hootdu_dismiss_welcome_notice', 'hootdu_dismiss_welcome_notice' );
 ...
 * @return void
 */
function hootdu_admin_enqueue_about_styles( $hook ) {
	if ( $hook == 'appearance_page_hoot-du-welcome' )
	...
	wp_localize_script( 'hoot-admin-about', 'hoot_dismissible_notice', array(
							...
							'ajax_action' => 'hootdu_dismiss_welcome_notice',
 ...
 * @return void
 */
function hootdu_appearance_subpage() {
	$activetab = 'upsell';
	if ( !empty( $_GET['tab'] ) )
	...
	<div class="wrap">
		...
		<h1 class="hoot-about-title"><?php
			...
			printf( esc_html__( 'About %1$s %2$s', 'hoot-du' ), hoot_data( 'template_name' ), hoot_data( 'template_version' ) );
			?></h1>
		...
		<div id="hoot-about-sub" class="hoot-about-sub">
			...
			<div class="hoot-about-text">
				<p class="hoot-about-intro"><?php esc_html_e( 'Hoot Du is a multipurpose highly flexible WordPress theme built on a SEO friendly framework with fast loading speed. It comes with multiple Theme Customizer options, various blog layouts, WooCommerce support etc among many other features.', 'hoot-du' ) ?></p>
				<p class="hoot-about-textlinks">
					<a class="button button-primary" href="https://wphoot.com/themes/hoot-du/" target="_blank"><span class="dashicons dashicons-dashboard"></span> <?php esc_html_e( 'View Premium', 'hoot-du' ) ?></a>
					<a class="button" href="https://demo.wphoot.com/hoot-du/" target="_blank"><span class="dashicons dashicons-welcome-view-site"></span> <?php esc_html_e( 'View Demo', 'hoot-du' ) ?></a>
					<a class="button" href="https://wphoot.com/support/hoot-du/" target="_blank"><span class="dashicons dashicons-editor-aligncenter"></span> <?php esc_html_e( 'Documentation', 'hoot-du' ) ?></a>
					<a class="button" href="https://wphoot.com/support/" target="_blank"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get Support', 'hoot-du' ) ?></a>
					<a class="button" href="https://wordpress.org/support/theme/hoot-du/reviews/?filter=5#new-post" target="_blank"><span class="dashicons dashicons-thumbs-up"></span> <?php esc_html_e( 'Rate Us', 'hoot-du' ) ?></a>
				</p>
				<?php do_action( 'hootdu_theme_after_about_textlinks', 'hoot-du' ); ?>
				<?php /*
				<div class="hoot-about-notice2">
					<h3><?php esc_html_e( '1 Click Demo Installation', 'hoot-du' ) ?></h3>
					<p><?php
						/* Translators: The %s are placeholders for HTML, so the order can't be changed. *//*
						printf( esc_html__( 'Use the OCDI plugin to install demo content with a single click to make your site look exactly like the %1$sDemo Site%2$s.%3$sNew users often find it easier to edit existing content rather than starting from scratch.', 'hoot-du' ), '<a href="https://demo.wphoot.com/hoot-du/" target="_blank">', '</a>', '<br />' );
					?></p>
					<p class="hoot-about-textlinks">
						<a class="button" href="https://wphoot.com/support/hoot-du/#docs-section-demo-content-free" target="_blank"><span class="dashicons dashicons-art"></span> <?php esc_html_e( 'Install Demo Content', 'hoot-du' ) ?></a>
					</p>
				</div>
				*/ ?>
			</div>
		...
		<div class="hoot-abouttabs">
			...
			<h2 id="nav-tabs" class="nav-tab-wrapper">
				<span class="nav-tab nav-upsell <?php if ( $activetab == 'upsell' ) echo 'nav-tab-active'; ?>" data-tabid="upsell"><?php esc_html_e( 'Premium Options', 'hoot-du' ) ?></span>
				<?php do_action( 'hootdu_theme_after_nav_tab_upsell', 'hoot-du', $activetab ); ?>
				<span class="nav-tab nav-qstart <?php if ( $activetab == 'qstart' ) echo 'nav-tab-active'; ?>" data-tabid="qstart"><?php esc_html_e( 'Quick Start Guide', 'hoot-du' ) ?></span>
			</h2>

			<div id="hoot-upsell" class="hoot-upsell hoot-tab <?php if ( $activetab == 'upsell' ) echo 'hoot-tab-active'; ?>">
				<h2 class="centered allcaps"><?php
					/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
					printf( esc_html__( 'Upgrade to %1$sHoot Du %2$sPremium%3$s%4$s', 'hoot-du' ), '<span>', '<strong>', '</strong>', '</span>' );
					?></h2>
				<p class="hoot-tab-intro centered"><?php
					/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
					printf( esc_html__( 'If you have enjoyed using Hoot Du, you are going to love %1$sHoot Du Premium%2$s.%3$sIt is a robust upgrade to Hoot Du that gives you many useful features.', 'hoot-du' ), '<strong>', '</strong>', '<br />' );
					?></p>
				<p class="hoot-tab-cta centered">
					<a class="button button-secondary secondary-cta" href="https://demo.wphoot.com/hoot-du/" target="_blank"><span class="dashicons dashicons-welcome-view-site"></span> <?php esc_html_e( 'View Demo Site', 'hoot-du' ) ?></a>
					<a class="button button-primary primary-cta" href="https://wphoot.com/themes/hoot-du/" target="_blank"><span class="dashicons dashicons-dashboard"></span> <?php esc_html_e( 'Buy Hoot Du Premium', 'hoot-du' ) ?></a>
				</p>
				<div class="hoot-tab-sub"><div class="hoot-tab-subinner">
					<?php hootdu_tabsections( 'features' ); ?>
			...
			<?php do_action( 'hootdu_theme_after_hoot_upsell', 'hoot-du', $activetab ); ?>

			<div id="hoot-qstart" class="hoot-qstart hoot-tab <?php if ( $activetab == 'qstart' ) echo 'hoot-tab-active'; ?>">
				<h2 class="centered allcaps"><span class="dashicons dashicons-clock"></span> <?php esc_html_e( 'Quick Start Guide', 'hoot-du' ); ?></h2>
				<p class="hoot-tab-intro centered"><?php
					/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
					printf( esc_html__( 'Follow these steps to quickly start developing your site.%1$sTo read the full documentation, or to get support from one of our support ninjas, click the buttons below.', 'hoot-du' ), '<br />' );
					?></p>
				<p class="hoot-tab-cta centered">
					<a class="button button-primary primary-cta" href="https://wphoot.com/support/hoot-du/" target="_blank"><span class="dashicons dashicons-editor-aligncenter"></span> <?php esc_html_e( 'View Full Documentation', 'hoot-du' ) ?></a>
					<a class="button button-secondary secondary-cta" href="https://wphoot.com/support/" target="_blank"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get Support', 'hoot-du' ) ?></a>
				</p>
				<div class="hoot-tab-sub hoot-qstart-sub"><div class="hoot-tab-subinner">
					<?php hootdu_tabsections( 'quickstart' ); ?>
					<div class="tabsection hoot-tab-cta centered">
						<a class="button button-primary primary-cta" href="https://wphoot.com/support/hoot-du/" target="_blank"><span class="dashicons dashicons-editor-aligncenter"></span> <?php esc_html_e( 'View Full Documentation', 'hoot-du' ) ?></a>
						<a class="button button-secondary secondary-cta" href="https://wphoot.com/support/" target="_blank"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get Support', 'hoot-du' ) ?></a>
					</div>
 ...
 * @return mixed
 */
function hootdu_tabsections( $string ) {
	if ( in_array( $string, array( 'features', 'importsteps', 'quickstart' ) ) ) :
		$features = hootdu_upstrings( $string );
 ...
 * @return mixed
 */
function hootdu_upstrings( $string ) {
	...
	$features[] = array(
		'name' => esc_html__( 'Custom Colors &amp; Backgrounds for Sections', 'hoot-du' ),
		'desc' => esc_html__( 'Hoot Du Premium lets you select custom colors and backgrounds for different sections of your site like header, footer, logo background, menu dropdown, content area, page title area etc.', 'hoot-du' ),
	...
	$features[] = array(
		...
		'desc' => esc_html__( 'Add carousel widgets to your post, in your sidebar, on your frontpage or in your footer. A simple drag and drop interface allows you to easily create and manage carousels.', 'hoot-du' ),
		'img' => $imagepath . 'premium-carousels.jpg',
		);

	$features[] = array(
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		'name' => sprintf( esc_html__( 'Floating %1$s%2$s\'Sticky\' Header%3$s &amp; %2$s\'Goto Top\'%3$s button (optional)', 'hoot-du' ), '<br>', '<span>', '</span>' ),
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
	...
	$features[] = array(
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		'name' => sprintf( esc_html__( 'One Page %1$sScrolling Website /%2$s %1$sLanding Page%2$s', 'hoot-du' ), '<span>', '</span>' ),
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
	...
	$features[] = array(
		...
		'desc' => esc_html__( 'Select from over 900 icons for your main navigation menu links.', 'hoot-du' ),
	...
	if ( class_exists( 'HootKit' ) ) {
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		$idesc = sprintf( esc_html__( '%1$sInstall the HootKit plugin to activate the One Click Demo Install.%2$s%3$sInstalled%4$s', 'hoot-du' ), '<span class="strikeout">', '</span>' ,'<hr><h4 class="okgreen"><span class="dashicons dashicons-yes"></span>', '</h4>' );
	} else {
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		$idesc = sprintf( esc_html__( 'Install the HootKit plugin to activate the One Click Demo Install.%1$sInstall HootKit plugin%2$s', 'hoot-du' ), '<hr><a class="button button-primary" href="' . esc_url( $tgmplink ) . '">', '</a>' );
	}
	$importsteps[] = array(
		'name' => esc_html__( 'Step 1', 'hoot-du' ),
		'desc' => $idesc,
		'style' => 'hero-top',
		);
	...
	$importsteps[] = array(
		'name' => esc_html__( 'Step 2', 'hoot-du' ),
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		'desc' => sprintf( esc_html__( 'Go to the %1$sInstall Theme Content%2$s page under the %3$sAppearance Menu%4$s', 'hoot-du' ), $ilink, $ilinkend, '<strong>', '</strong>' ),
		'style' => 'hero-top',
		);

	$importsteps[] = array(
		'name' => esc_html__( 'Step 3', 'hoot-du' ),
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		'desc' => sprintf( esc_html__( 'Click the %1$sInstall Demo Content%2$s button and wait for the installation process to finish', 'hoot-du' ), '<strong>', '</strong>' ),
	...
	$quickstart[] = array(
		'name' => esc_html__( 'Setup Frontpage and Blog Page', 'hoot-du' ),
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		'desc' => sprintf( esc_html__( 'Users often want to create a landing Homepage/Frontpage to welcome their visitors, while a separate \'Blog\' page to list all their blog posts. To do this, follow these steps:%9$s%1$s
			...
			%2$s', 'hoot-du' ), '<ol>', '</ol>', '<li>', '</li>', '<strong>', '</strong>', '<em>', '</em>', '<br />',
	...
	$quickstart[] = array(
		'name' => esc_html__( 'Setup Main Navigation Menu', 'hoot-du' ),
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		'desc' => sprintf( esc_html__( '%1$s
			...
			', 'hoot-du' ), '<ol>', '</ol>', '<li>', '</li>', '<strong>', '</strong>', '<em>', '</em>', '<br />',
	...
	$quickstart[] = array(
		'name' => esc_html__( 'Add Content to Frontpage', 'hoot-du' ),
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		'desc' => sprintf( esc_html__( '%1$s
			...
			', 'hoot-du' ), '<ol>', '</ol>', '<li>', '</li>', '<strong>', '</strong>', '<em>', '</em>', '<hr>',
	...
	if ( !class_exists( 'HootKit' ) ) {
		...
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		$idesc = sprintf( esc_html__( '%1$s%2$s%4$sHootKit plugin is currently not active on your site.%5$sWe highly recommend %6$sinstalling and activating the HootKit plugin%7$s before you import demo content. If HootKit plugin is not active, the demo widgets will not get imported and you may not get the desired results.%3$s', 'hoot-du' ), '<hr>', '<span style="border: solid 1px #b6d7e8;color: #5091b2;background: #e9f7fe;display: block;padding: 5px 10px;font-size: 0.8em;line-height: 1.7em;">', '</span>', '<span style="display: block;font-weight: bold;text-transform: uppercase;">', '</span>', '<a href="' . esc_url( admin_url( 'themes.php?page=tgmpa-install-plugins' ) ) . '">', '</a>' );
	} else {
		$idesc = '';
	}
	...
	$quickstart[] = array(
		/* Translators: 1 is a line break */
		'name' => sprintf( esc_html__( '[Optional]%1$sInstall Demo Content', 'hoot-du' ), '<br />' ),
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		'desc' => sprintf( esc_html__( '%14$sIt is recommended to install demo content only on a fresh new site%15$s
			...
			%2$s', 'hoot-du' ), '<ol>', '</ol>', '<li>', '</li>', '<strong>', '</strong>', '<em>', '</em>', '<hr>',
										'<a href="https://demo.wphoot.com/hoot-du/" target="_blank">',
										'<a href="https://wphoot.com/support/hoot-du/#docs-section-demo-content-free" target="_blank">',
