...
/* Register sidebars. */
add_action( 'widgets_init', 'hootdu_base_register_sidebars', 5 );
add_action( 'widgets_init', 'hootdu_frontpage_register_sidebars' );
 ...
 * @return void
 */
function hootdu_base_register_sidebars() {
	...
	$extramsg = ( hoot_get_mod( 'primary_menuarea' ) == 'widget-area' ) ? '' : ' ' . $emstart . __( "This widget area is currently NOT VISIBLE on your site. To activate it, go to Appearance &gt; Customize &gt; Header &gt; 'Header Area' option &gt; Select 'Header Side Widget Area'", 'hoot-du' ) . $emend;
	hoot_register_sidebar(
		array(
			'id'           => 'hoot-header',
	...
	$extramsg = ( hoot_get_mod( 'secondary_menu_location' ) != 'none' ) ? '' : ' ' . $emstart . __( "This widget area is currently NOT VISIBLE on your site. To activate it, go to Appearance &gt; Customize &gt; Header &gt; 'Full Width Menu' option &gt; Select 'Top' or 'Bottom'", 'hoot-du' ) . $emend;
	hoot_register_sidebar(
		array(
			'id'           => 'hoot-menu-side',
	...
	// Footer Columns
	$footercols = hootdu_get_footer_columns();
 ...
 * @return void
 */
function hootdu_frontpage_register_sidebars() {
	...
	/* Set up defaults */
	$defaults = apply_filters( 'hootdu_frontpage_widgetarea_ids', array( 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j' ) );
	$locations = apply_filters( 'hootdu_frontpage_widgetarea_names', array(
		__( 'Left', 'hoot-du' ),
