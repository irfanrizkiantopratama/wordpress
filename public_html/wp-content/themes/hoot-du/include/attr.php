...
add_filter( 'hoot_attr_header',   'hootdu_attr_header',   7, 2 );
add_filter( 'hoot_attr_menu',     'hootdu_attr_menu',     7, 2 );
add_filter( 'hoot_attr_content',  'hootdu_attr_content',  7    );
add_filter( 'hoot_attr_sidebar',  'hootdu_attr_sidebar',  7, 2 );
add_filter( 'hoot_attr_branding', 'hootdu_attr_branding', 7    );

/* New Theme Filters */
add_filter( 'hoot_attr_page-wrapper',      'hootdu_attr_page_wrapper',      7    );
add_filter( 'hoot_attr_topbar',            'hootdu_attr_topbar',            7    );
add_filter( 'hoot_attr_header-part',       'hootdu_attr_header_part',       7, 2 );
add_filter( 'hoot_attr_header-aside',      'hootdu_attr_header_aside',      7    );
add_filter( 'hoot_attr_below-header',      'hootdu_attr_below_header',      7    );
add_filter( 'hoot_attr_main',              'hootdu_attr_main',              7    );
add_filter( 'hoot_attr_frontpage-grid',    'hootdu_attr_frontpage_grid',    7    );
add_filter( 'hoot_attr_frontpage-content', 'hootdu_attr_frontpage_content', 7    );
add_filter( 'hoot_attr_frontpage-area',    'hootdu_attr_frontpage_area',    7, 2 );
add_filter( 'hoot_attr_loop-meta-wrap',    'hootdu_attr_loop_meta_wrap',    7, 2 );
add_filter( 'hoot_attr_loop-meta',         'hootdu_attr_loop_meta',         7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_loop-title',        'hootdu_attr_loop_title',        7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_loop-description',  'hootdu_attr_loop_description',  7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_content-wrap',      'hootdu_attr_content_wrap',      7, 2 );
add_filter( 'hoot_attr_sidebar-wrap',      'hootdu_attr_sidebar_wrap',      7, 2 );
add_filter( 'hoot_attr_sub-footer',        'hootdu_attr_sub_footer',        7    );
add_filter( 'hoot_attr_post-footer',       'hootdu_attr_post_footer',       7    );
 ...
 * @return array
 */
function hootdu_attr_header( $attr, $context ) {
 ...
 * @return array
 */
function hootdu_attr_menu( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hootdu_attr_content( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];

	$layout_class = hootdu_layout_class( 'content' );
 ...
 * @return array
 */
function hootdu_attr_sidebar( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	if ( !empty( $context ) && ( $context == 'primary' || $context == 'secondary' ) ) {
		$layout_class = hootdu_layout_class( "sidebar" );
		if ( !empty( $layout_class ) )
			$attr['class'] .= $layout_class;
	}
 ...
 * @return array
 */
function hootdu_attr_branding( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hootdu_attr_page_wrapper( $attr ) {
	...
	$classes = apply_filters( 'hootdu_attr_page_wrapper_plugins', array( 'hoot-cf7-style', 'hoot-mapp-style', 'hoot-jetpack-style' ) );
 ...
 * @return array
 */
function hootdu_attr_topbar( $attr ) {
	$attr['id'] = 'topbar';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['class'] .= ' topbar';
	return $attr;
 ...
 * @return array
 */
function hootdu_attr_header_part( $attr, $context ) {
 ...
 * @return array
 */
function hootdu_attr_header_aside( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_below_header( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_main( $attr ) {
	$attr['id'] = 'main';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['class'] .= ' main';
	return $attr;
 ...
 * @return array
 */
function hootdu_attr_frontpage_grid( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hootdu_attr_frontpage_content( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_frontpage_area( $attr, $context ) {
 ...
 * @return array
 */
function hootdu_attr_loop_meta_wrap( $attr, $context ) {
 ...
 * @return array
 */
function hootdu_attr_loop_meta( $attr, $context ) {
 ...
 * @return array
 */
function hootdu_attr_loop_title( $attr, $context ) {
 ...
 * @return array
 */
function hootdu_attr_loop_description( $attr, $context ) {
 ...
 * @return array
 */
function hootdu_attr_content_wrap( $attr, $context ) {
 ...
 * @return array
 */
function hootdu_attr_sidebar_wrap( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hootdu_attr_sub_footer( $attr ) {
	$attr['id'] = 'sub-footer';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hootdu_attr_post_footer( $attr ) {
	$attr['id'] = 'post-footer';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
