...
/* Add custom scripts. */
add_action( 'wp_enqueue_scripts', 'hootdu_enqueue_scripts', 9 );
...
add_action( 'wp_enqueue_scripts', 'hootdu_localize_script', 9 );
...
add_action( 'wp_enqueue_scripts', 'hootdu_base_enqueue_scripts', 11 );
...
add_action( 'wp_enqueue_scripts', 'hootdu_enqueue_styles', 10 );

/* Dequeue font awesome */
add_action( 'wp_enqueue_scripts', 'hootdu_dequeue_fontawesome', 99 );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_enqueue_scripts' ) ) :
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_localize_script' ) ) :
function hootdu_localize_script() {
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_base_enqueue_scripts' ) ) :
function hootdu_base_enqueue_scripts() {
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_enqueue_styles' ) ) :
function hootdu_enqueue_styles() {

	/* Load Google Fonts if 'google-fonts' is active. */
	$style_uri = hootdu_google_fonts_enqueue_url();
	if ( $style_uri )
		wp_enqueue_style( 'hootdu-googlefont', $style_uri, array(), null );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_dequeue_fontawesome' ) ) :
function hootdu_dequeue_fontawesome() {
