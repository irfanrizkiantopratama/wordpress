...
add_action( 'after_setup_theme', 'hootdu_includes', 10 );
...
function hootdu_includes() {
	...
	/* Load TGMPA Class */
	if ( apply_filters( 'hootdu_load_tgmpa', file_exists( hoot_data()->incdir . 'admin/class-tgm-plugin-activation.php' ) ) )
		require_once( hoot_data()->incdir . 'admin/class-tgm-plugin-activation.php' );
	/* Load Customizer Options */
	if ( apply_filters( 'hootdu_customize_load_trt', file_exists( hoot_data()->incdir . 'admin/trt-customize-pro/class-customize.php' ) ) )
	...
	/* Load the about page. */
	if ( apply_filters( 'hootdu_load_about', file_exists( hoot_data()->incdir . 'admin/about.php' ) ) )
