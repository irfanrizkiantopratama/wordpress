...
do_action( 'hootdu_frontpage' );

// Loads the header.php template.
get_header();

// Template modification Hook
do_action( 'hootdu_before_content_grid', 'frontpage.php' );
?>
...
<div <?php hoot_attr( 'frontpage-grid' ); ?>>
	...
	<main <?php hoot_attr( 'frontpage-content' ); ?>>
		...
		<?php
		// Template modification Hook
		do_action( 'hootdu_main_start', 'frontpage.php' );
			...
			foreach ( $sections as $key => $section ) :
				if ( empty( $section[ 'sortitem_hide' ] ) ):
					...
					elseif ( $key == 'content' )
						...
						$areatype = $key;
					$areatype = apply_filters( 'hootdu_frontpage_sections_switch', $areatype, $key, $sections );

					// Exit the loop except main content for a paged post list (blog)
					if ( $areatype != 'content-blog' && apply_filters( 'hootdu_paged_frontpage_hidemodules', is_paged() ) )
						continue;
					...
					if ( $custom_template ):
						...
						switch( $areatype ):
							...
							case 'widgetarea':
								...
								$structure = hootdu_get_column_span( $section['columns'] );
										...
										<div <?php hoot_attr( 'content' ); ?>>
											<div <?php hoot_attr( 'content-wrap', 'frontpage-blog' ); ?>>
												...
												if ( have_posts() ) :
													...
													// Template modification Hook
													do_action( 'hootdu_loop_start', 'frontpage.php' );
													...
													// Template modification Hook
													do_action( 'hootdu_loop_end', 'frontpage.php' );
							...
							default:
								...
								do_action( 'hootdu_frontpage_sections', $areatype, $sections, $section_class, $context );
		...
		// Template modification Hook
		do_action( 'hootdu_main_end', 'frontpage.php' );
		?>
	...
	<?php
	// Template modification Hook
	do_action( 'hootdu_after_main', 'frontpage.php' );
	?>
