...
?>
	...
	<aside <?php hoot_attr( 'sidebar', 'primary' ); ?>>
		...
		do_action( 'hootdu_sidebar_start', 'shop' );
		...
		// Template modification Hook
		do_action( 'hootdu_sidebar_end', 'shop' );
	...
	?>
		...
		<aside <?php hoot_attr( 'sidebar', 'secondary' ); ?>>
			...
			// Template modification Hook
			do_action( 'hootdu_sidebar_start', 'shop-secondary' );
			...
			// Template modification Hook
			do_action( 'hootdu_sidebar_end', 'shop-secondary' );
