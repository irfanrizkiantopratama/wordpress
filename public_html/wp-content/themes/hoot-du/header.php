...
<body <?php hoot_attr( 'body' ); ?>>
	...
	<a href="#main" class="screen-reader-text"><?php esc_html_e( 'Skip to content', 'hoot-du' ); ?></a>
	...
	<div <?php hoot_attr( 'page-wrapper' ); ?>>
		...
		<header <?php hoot_attr( 'header' ); ?>>
			...
			hootdu_secondary_menu( 'top' );
			?>

			<div <?php hoot_attr( 'header-part', 'primary', 'contrast-typo' ); ?>>
				<div class="hgrid">
		...
		<div <?php hoot_attr( 'main' ); ?>>
			<?php
			// Template modification Hook
			do_action( 'hootdu_main_wrapper_start' );