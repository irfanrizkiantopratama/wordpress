...
hootdu_add_custom_title_content( 'pre', 'archive-product.php' );
if ( hootdu_titlearea_top() ) {
	hootdu_loopmeta_header_img( 'shop', false );
	...
	hootdu_add_custom_title_content( 'post', 'archive-product.php' );
} else {
	hootdu_loopmeta_header_img( 'shop', true );
}

// Template modification Hook
do_action( 'hootdu_before_content_grid', 'archive-product.php' );
?>
...
<div class="hgrid main-content-grid">
	...
	<main <?php hoot_attr( 'content' ); ?>>
		<div <?php hoot_attr( 'content-wrap', 'archive-product' ); ?>>
			...
			<?php
			// Template modification Hook
			do_action( 'hootdu_main_start', 'archive-product.php' );
			...
			if ( ( function_exists( 'woocommerce_product_loop' ) && woocommerce_product_loop() ) || have_posts() ) :
				...
				// Template modification Hook
				do_action( 'hootdu_before_loop_nav', 'archive-product.php' );
			...
			// Template modification Hook
			do_action( 'hootdu_main_end', 'archive-product.php' );
			?>
