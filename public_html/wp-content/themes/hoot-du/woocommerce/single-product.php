...
hootdu_add_custom_title_content( 'pre', 'single-product.php' );
if ( hootdu_titlearea_top() ) {
	...
	hootdu_add_custom_title_content( 'post', 'single-product.php' );
}

// Template modification Hook
do_action( 'hootdu_before_content_grid', 'single-product.php' );
?>
...
<div class="hgrid main-content-grid">
	...
	<main <?php hoot_attr( 'content' ); ?>>
		<div <?php hoot_attr( 'content-wrap', 'single-product' ); ?>>
			...
			<?php
			// Template modification Hook
			do_action( 'hootdu_main_start', 'single-product.php' );
			...
			<?php if ( have_posts() ) : ?>
				...
				// Template modification Hook
				do_action( 'hootdu_loop_start', 'single-product.php' );
				?>
				...
				<?php
				// Template modification Hook
				do_action( 'hootdu_loop_end', 'single-product.php' );

				// Template modification Hook
				do_action( 'hootdu_after_content_wrap', 'single-product.php' );
				?>
			...
			// Template modification Hook
			do_action( 'hootdu_main_end', 'single-product.php' );
			?>
