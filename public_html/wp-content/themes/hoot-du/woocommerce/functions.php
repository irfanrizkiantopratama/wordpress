 ...
 * @return void
 */
if ( !function_exists( 'hootdu_woo_setup' ) ) :
function hootdu_woo_setup() {
...
add_action( 'wp', 'hootdu_woo_setup' );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_woo_register_sidebars' ) ) :
function hootdu_woo_register_sidebars() {
...
add_action( 'widgets_init', 'hootdu_woo_register_sidebars' );
 ...
 * @return array
 */
if ( !function_exists( 'hootdu_woo_attr_sidebar' ) ) :
function hootdu_woo_attr_sidebar( $attr, $context ) {
...
add_filter( 'hoot_attr_sidebar', 'hootdu_woo_attr_sidebar', 11, 2 );
 ...
 * @return array
 */
if ( !function_exists( 'hootdu_woo_layout' ) ) :
function hootdu_woo_layout( $sidebar ) {
	...
	$forcenosidebar = apply_filters( 'hootdu_woo_pages_force_nosidebar', true );
...
add_filter( 'hootdu_layout', 'hootdu_woo_layout' );
 ...
 * @param string $context
 */
if ( !function_exists('hootdu_woo_meta_info_blocks_display') ) :
function hootdu_woo_meta_info_blocks_display( $display, $context ) {
	if ( is_woocommerce() || is_cart() || is_checkout() || is_account_page() )
		$display = array();
	return $display;
}
endif;
add_filter( 'hoot_meta_info', 'hootdu_woo_meta_info_blocks_display', 10, 2 );
 ...
 * @return int
 */
if ( !function_exists('hootdu_woo_loop_per_page') ) :
function hootdu_woo_loop_per_page( $value ) {
	return intval( hoot_get_mod( 'wooshop_products' ) );
}
endif;
add_filter( 'loop_shop_per_page', 'hootdu_woo_loop_per_page', 20 );
 ...
 * @return int
 */
if ( !function_exists('hootdu_woo_loop_columns') ) :
function hootdu_woo_loop_columns( $value ) {
	return intval( hoot_get_mod( 'wooshop_product_columns' ) );
}
endif;
add_filter( 'loop_shop_columns', 'hootdu_woo_loop_columns', 999 );
 ...
 * @return void
 */
if ( !function_exists('hootdu_woo_custom_loop_columns_css') ) :
function hootdu_woo_custom_loop_columns_css() {
...
add_action( 'wp_enqueue_scripts', 'hootdu_woo_custom_loop_columns_css', 99 );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_woo_set_queried_object' ) ) :
function hootdu_woo_set_queried_object( $q ){
	if ( $q->is_main_query() )
		$r = get_queried_object();
}
endif;
add_action( 'pre_get_posts', 'hootdu_woo_set_queried_object', 9 );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_woo_loop_hide_product_meta' ) ) :
function hootdu_woo_loop_hide_product_meta() {
