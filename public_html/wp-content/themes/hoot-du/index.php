...
hootdu_add_custom_title_content( 'pre', 'index.php' );
if ( hootdu_titlearea_top() ) {
	hootdu_loopmeta_header_img( 'index', false );
	get_template_part( 'template-parts/loop-meta' ); // Loads the template-parts/loop-meta.php template to display Title Area with Meta Info (of the loop)
	hootdu_add_custom_title_content( 'post', 'index.php' );
} else {
	hootdu_loopmeta_header_img( 'index', true );
}

// Template modification Hook
do_action( 'hootdu_before_content_grid', 'index.php' );
?>
...
<div class="hgrid main-content-grid">
	...
	<main <?php hoot_attr( 'content' ); ?>>
		<div <?php hoot_attr( 'content-wrap', 'index' ); ?>>
			...
			<?php
			// Template modification Hook
			do_action( 'hootdu_main_start', 'index.php' );
			...
			if ( have_posts() ) :
				...
				// Template modification Hook
				do_action( 'hootdu_loop_start', 'index.php' );
				...
				// Template modification Hook
				do_action( 'hootdu_loop_end', 'index.php' );

				echo '</div>';

				// Template modification Hook
				do_action( 'hootdu_before_loop_nav', 'index.php' );
			...
			// Template modification Hook
			do_action( 'hootdu_main_end', 'index.php' );
			?>
