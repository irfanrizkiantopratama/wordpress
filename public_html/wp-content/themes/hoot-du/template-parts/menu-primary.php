...
do_action( 'hootdu_before_menu', 'primary' );

if ( has_nav_menu( 'hoot-primary-menu' ) ) : // Check if there's a menu assigned to the 'primary' location.

	?>
	<div class="screen-reader-text"><?php esc_html_e( 'Primary Navigation Menu', 'hoot-du' ); ?></div>
...
// Template modification Hook
do_action( 'hootdu_after_menu', 'primary' );