 ...
 */
$display_loop_meta = apply_filters( 'hootdu_woo_display_loop_meta', true );
do_action( 'hootdu_woo_loop_meta', 'start' );
...
if ( !is_product() && !is_singular() ) :
	...
	$display_title = apply_filters( 'hootdu_woo_loop_meta_display_title', true, 'plural' );
...
elseif ( is_product() ) :
	...
	add_filter( 'hootdu_loop_meta_display_title', 'hootdu_woo_loop_hide_product_meta' );
 ...
 * Template modification Hooks
 */
do_action( 'hootdu_woo_loop_meta', 'end' );