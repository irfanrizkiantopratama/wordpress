...
do_action( 'hootdu_before_below_header' );
...
if ( !empty( $hoot_below_header_left ) || !empty( $hoot_below_header_right ) ) :
	...
	?>
	<div <?php hoot_attr( 'below-header', '', 'contrast-typo inline-nav js-search hgrid-stretch' ); ?>>
		<div class="hgrid">
			<div class="hgrid-span-12">
				...
				<div class="below-header-inner table<?php if ( !empty( $hoot_below_header_left ) && !empty( $hoot_below_header_right ) ) echo ' below-header-parts'; ?>">
					...
					if ( $hoot_below_header_left ):
						...
						// Template modification Hook
						do_action( 'hootdu_sidebar_start', 'below-header-left', $below_headerid );
						?>
						...
						<?php
						// Template modification Hook
						do_action( 'hootdu_sidebar_end', 'below-header-left', $below_headerid );
					...
					if ( $hoot_below_header_right ):
						...
						// Template modification Hook
						do_action( 'hootdu_sidebar_start', 'below-header-right', $below_headerid );
						?>
						...
						<?php
						// Template modification Hook
						do_action( 'hootdu_sidebar_end', 'below-header-right', $below_headerid );
...
// Template modification Hook
do_action( 'hootdu_after_below_header' );