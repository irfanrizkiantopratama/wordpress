<?php
/**
 * Slider (PostsListCarousel) Widget
 *
 * @package           Hootkit
 ...
 */
class HootKit_Slider_Postlistcarousel_Widget extends HootKit_WP_Widget {

	function __construct() {

		$settings['id'] = 'hootkit-slider-postlistcarousel';
		$settings['name'] = __( 'HootKit > Posts List Carousel', 'hootkit' );
	...
	function display_widget( $instance, $before_title = '', $title = '', $after_title = '' ) {
		...
		$slider_template = hoot_get_widget( 'slider-postlistcarousel', false );
		// Fire up the template
		extract( $instance, EXTR_SKIP );
		if ( is_string( $slider_template ) && file_exists( $slider_template ) ) include ( hootkit()->dir . 'include/slider-postlistcarousel.php' );
	}
