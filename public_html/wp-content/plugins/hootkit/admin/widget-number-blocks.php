 ...
 */
class HootKit_Number_Blocks_Widget extends HootKit_WP_Widget {

	function __construct() {

		$settings['id'] = 'hootkit-number-blocks';
		$settings['name'] = __( 'HootKit > Number Blocks', 'hootkit' );
			...
			'boxes' => array(
				...
				'fields'	=> array(
					'percent' => array(
						...
						'desc'		=> __( 'A number between 0-100 used to calculate the circle length around the number', 'hootkit' ),
						'type'		=> 'text',
						'std'		=> '75',
					...
					'number' => array(
						...
						'desc'		=> __( 'Leave empty to use above percentage (a % sign will be automatically added)', 'hootkit' ),
						'type'		=> 'text',
