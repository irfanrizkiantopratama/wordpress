 ...
 */
class HootKit_Social_Icons_Widget extends HootKit_WP_Widget {

	function __construct() {

		$settings['id'] = 'hootkit-social-icons';
		$settings['name'] = __( 'HootKit > Social Icons', 'hootkit' );
	...
	function display_widget( $instance, $before_title = '', $title = '', $after_title = '' ) {
		...
		$widget_template = ( $widget_template ) ? $widget_template : hootkit()->dir . 'template/widget-social-icons.php';
