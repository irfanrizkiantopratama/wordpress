 ...
 */
class HootKit_Profile_Widget extends HootKit_WP_Widget {

	function __construct() {

		$settings['id'] = 'hootkit-profile';
		$settings['name'] = __( 'HootKit > About/Profile', 'hootkit' );
	...
	function display_widget( $instance, $before_title = '', $title = '', $after_title = '' ) {
		...
		$widget_template = ( $widget_template ) ? $widget_template : hootkit()->dir . 'template/widget-profile.php';
